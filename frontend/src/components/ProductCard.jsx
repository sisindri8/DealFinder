...
export default function ProductCard({ product, featured = false }) {
  ...
  if (featured) return <FeaturedCard product={product} colors={colors} imgError={imgError} setImgError={setImgError} />
  return <CompactCard product={product} colors={colors} imgError={imgError} setImgError={setImgError} />
}
...
function FeaturedCard({ product, colors, imgError, setImgError }) {
  return (
    <div style={{
      background: 'var(--bg2)',
...
function CompactCard({ product, colors, imgError, setImgError }) {
  return (
    <div style={{
      background: 'var(--bg2)',
      border: '1px solid var(--border)',
